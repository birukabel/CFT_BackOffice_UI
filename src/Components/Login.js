      ...
      get(
       ...
       /* if (!result.data) {
         ...
         if (result.data) {setToken(result.data);
          localStorage.setItem("userName",loggedUser.userName.toLocaleLowerCase())
        }
      });
  };
            ...
            <form onSubmit={populateUserToken}>
              <FormControl>
                <TextField
                  ...
                  InputProps={{
                    endAdornment: <InputAdornment position="end"><AccountCircleOutlined /></InputAdornment>,
                  }}
                ></TextField>
                <TextField
                  name="password"
